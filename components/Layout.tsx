  ...
  return (
    <div className="flex h-screen bg-transparent overflow-hidden relative transition-colors duration-300 font-sans selection:bg-indigo-100 dark:selection:bg-indigo-900/30 selection:text-indigo-900 dark:selection:text-indigo-100">
      ...
      <aside className={`
        ...
        border-r border-slate-200 dark:border-slate-800 transition-transform duration-300 ease-in-out shadow-2xl md:shadow-none flex flex-col
        ${mobileMenuOpen ? 'translate-x-0' : '-translate-x-full'} md:relative md:translate-x-0
      `}>
        {/* Brand Header */}
        <div className="flex items-center gap-3 px-6 h-[72px] shrink-0 border-b border-transparent dark:border-white/5">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
        {/* Top Header */}
        <header className="flex items-center justify-between px-6 md:px-8 h-[72px] shrink-0 border-b border-slate-200 dark:border-slate-800/60 bg-white/70 dark:bg-[#020617]/70 backdrop-blur-md sticky top-0 z-40 transition-colors">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="hidden md:flex items-center gap-2 px-3 py-1.5 bg-slate-100/50 dark:bg-slate-900/50 border border-slate-200 dark:border-slate-800 rounded-lg text-xs text-slate-500 cursor-default hover:border-slate-300 dark:hover:border-slate-700 transition-colors">
