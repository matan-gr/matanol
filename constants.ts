...
import { FileText, Server, Activity, Settings, Network, Gauge } from 'lucide-react';

export const APP_NAME = "Matan-O-Labeler";
export const APP_VERSION = "4.0.0-enterprise";
